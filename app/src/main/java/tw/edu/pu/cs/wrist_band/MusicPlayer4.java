...
public class MusicPlayer4 extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        songName.setText("再出發-任賢齊");
        mediaPlayer = MediaPlayer.create(this, R.raw.goal);
