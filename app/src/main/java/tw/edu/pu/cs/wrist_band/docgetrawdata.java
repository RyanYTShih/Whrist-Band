...
public class docgetrawdata extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_docgetrawdata);
        Spinner spinner3 = (Spinner)findViewById(R.id.spinner3);
        final String[] where = {"社區選擇","靜宜社區", "宜靜社區", "靜宜一街", "宜靜一街", "靜宜街坊"};
        ArrayAdapter<String> whereList = new ArrayAdapter<>(docgetrawdata.this,
                android.R.layout.simple_spinner_dropdown_item,
                where);
        spinner3.setAdapter(whereList);
        Spinner spinner5 = (Spinner)findViewById(R.id.spinner5);
        final String[] people = {"人物選擇", "林小宏", "時小唐", "張小心", "廖小勛"};
        ArrayAdapter<String> peopleList = new ArrayAdapter<>(docgetrawdata.this,
                android.R.layout.simple_spinner_dropdown_item,
                people);
        ...
        ArrayAdapter<String> monthList = new ArrayAdapter<>(docgetrawdata.this,
                android.R.layout.simple_spinner_dropdown_item,
                month);
        ...
        ArrayAdapter<String> dayList = new ArrayAdapter<>(docgetrawdata.this,
                android.R.layout.simple_spinner_dropdown_item,
                day);
    ...
    private Button.OnClickListener myListener = new
            Button.OnClickListener() {
                ...
                public void onClick(View v) {
                    switch (v.getId()) {
                        case R.id.button12: {
                            intent = new Intent(docgetrawdata.this, getRawDatainput.class);
